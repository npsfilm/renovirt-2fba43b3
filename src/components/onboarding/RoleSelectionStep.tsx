            ...
            return (
              ...
              >
                <div className="flex items-start space-x-2 lg:space-x-3">
                  <div className={`p-2 lg:p-3 rounded-lg shrink-0 transition-all duration-300 ${
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-1 lg:gap-2">
                      {role.benefits.map((benefit, index) => (
                        <span
                          key={index}
                          className={`px-2 lg:px-3 py-1 rounded-full text-xs font-medium transition-all duration-300 ${
                            isSelected
          ...
          >
            <div className="flex items-start space-x-2 lg:space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs lg:text-sm text-muted-foreground leading-relaxed">Andere Rolle (bitte angeben)</p>
              </div>
            </div>
          </button>

          {showOther && (
            <div className="ml-8 lg:ml-10 space-y-2 animate-in slide-in-from-top-2 duration-300">
              <input
                type="text"
                value={otherRole}
