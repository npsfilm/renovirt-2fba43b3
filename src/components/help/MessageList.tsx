...
const MessageList = ({
  ...
  return <ScrollArea className="flex-1 p-4 pr-5 pb-6 overflow-x-hidden">
      <div className="space-y-4">
        ...
        {messages.map(message => <ChatMessage key={message.id} message={message} onFeedback={onFeedback} onContactSupport={onContactSupport} onSendChatHistory={onSendChatHistory} onOpenContactForm={onOpenContactForm} onSendTranscript={onSendTranscript} onProblemSolved={onProblemSolved} />)}
        
        {isLoading && <div className="flex items-center gap-2 text-gray-500 mb-4">
