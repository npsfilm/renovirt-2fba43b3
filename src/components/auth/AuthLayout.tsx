...
const AuthLayout = ({
  ...
  return <div className="h-screen bg-background flex overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-background">
        ...
        x: 0
          ...
          <div className="mb-6 text-center">
            <img src="/lovable-uploads/9ec7c3ad-34b9-4fea-a9e9-0d4a0a5532e9.png" alt="Renovirt Logo" className="h-8 mx-auto mb-4" />
          </div>
          {children}
        </motion.div>
      </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden h-full">
        ...
        <div className="relative z-10 flex flex-col justify-between p-8 text-white h-full w-full">
          ...
          <div className="flex flex-col justify-center flex-1 max-w-lg">
            ...
            delay: 0.2
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold leading-tight">Willkommen bei Renovirt</h1>
                <h2 className="text-2xl font-bold text-accent">Professionelle Bildbearbeitung für Immobilien – in 48 Stunden.</h2>
                <p className="text-lg text-white/90 leading-relaxed">Melden Sie sich an, um neue Aufträge zu starten oder Ihre Projekte zu verwalten.</p>
              </div>
            ...
            delay: 0.4
          }} className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20 mt-6">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-gradient-to-br from-accent to-primary rounded-full flex items-center justify-center text-white font-bold text-xs">
                  MS
                </div>
                <div>
          ...
          delay: 0.6
            ...
            <div className="flex items-center justify-center space-x-4 opacity-70">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 flex items-center justify-center h-8">
                <img src="/lovable-uploads/3edc84fd-1de7-4266-ac80-24a4925dd856.png" alt="Engel & Völkers" className="h-5 max-w-[80px] object-contain" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 flex items-center justify-center h-8">
                <img src="/lovable-uploads/e6bd750d-a87a-45ce-84cf-065e03bd72c7.png" alt="Century 21" className="h-5 max-w-[80px] object-contain" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 flex items-center justify-center h-8">
                <img src="/lovable-uploads/8c510237-f833-4180-8a51-f663f2012aee.png" alt="Volksbank" className="h-5 max-w-[80px] object-contain" />
              </div>
            </div>
            <div className="flex items-center justify-center space-x-4 opacity-70">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 flex items-center justify-center h-8">
                <img src="/lovable-uploads/4127c5fe-1b1e-427e-bd36-ef661e04f853.png" alt="Bricks & Mortar" className="h-5 max-w-[80px] object-contain" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 flex items-center justify-center h-8">
                <img src="/lovable-uploads/5c28de02-7e7b-4dfa-9009-20e385d6295a.png" alt="McMakler" className="h-5 max-w-[80px] object-contain" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 flex items-center justify-center h-8">
                <img src="/lovable-uploads/34d808bf-8414-4e4d-9dd4-cda24c19367d.png" alt="Von Poll" className="h-5 max-w-[80px] object-contain" />
              </div>
            </div>
