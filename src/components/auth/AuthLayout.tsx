      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background">
        ...
        x: 0
          ...
          <div className="mb-12 text-center">
            <img src="/lovable-uploads/9ec7c3ad-34b9-4fea-a9e9-0d4a0a5532e9.png" alt="Renovirt Logo" className="h-10 mx-auto mb-8" />
          </div>
          {children}
        </motion.div>
      </div>
          ...
          delay: 0.6
            ...
            <div className="flex items-center justify-center space-x-6 opacity-70">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 flex items-center justify-center h-12">
                <img src="/lovable-uploads/3edc84fd-1de7-4266-ac80-24a4925dd856.png" alt="Engel & Völkers" className="h-8 max-w-[120px] object-contain" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 flex items-center justify-center h-12">
                <img src="/lovable-uploads/e6bd750d-a87a-45ce-84cf-065e03bd72c7.png" alt="Century 21" className="h-8 max-w-[120px] object-contain" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 flex items-center justify-center h-12">
                <img src="/lovable-uploads/8c510237-f833-4180-8a51-f663f2012aee.png" alt="Volksbank" className="h-8 max-w-[120px] object-contain" />
              </div>
            </div>
            <div className="flex items-center justify-center space-x-6 opacity-70 mt-3">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 flex items-center justify-center h-12">
                <img src="/lovable-uploads/4127c5fe-1b1e-427e-bd36-ef661e04f853.png" alt="Bricks & Mortar" className="h-8 max-w-[120px] object-contain" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 flex items-center justify-center h-12">
                <img src="/lovable-uploads/5c28de02-7e7b-4dfa-9009-20e385d6295a.png" alt="McMakler" className="h-8 max-w-[120px] object-contain" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 flex items-center justify-center h-12">
                <img src="/lovable-uploads/34d808bf-8414-4e4d-9dd4-cda24c19367d.png" alt="Von Poll" className="h-8 max-w-[120px] object-contain" />
              </div>
            </div>
