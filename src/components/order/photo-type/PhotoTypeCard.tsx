      ...
      `}>
        <CardContent className="p-3 md:p-6 text-center relative">
          <div className="absolute top-2 right-2 md:top-4 md:right-4">
            <RadioGroupItem value={id} id={id} className={`w-4 h-4 md:w-5 md:h-5 transition-colors duration-200 ${isSelected ? 'border-primary text-primary' : 'border-muted-foreground'}`} />
          </div>
